...
Advanced document analysis with AI-powered insights using OpenAI"""
...
async def answer_question(question: str, relevant_chunks: List[str]) -> str:
    ...
    try:
        ...
        system_prompt = """You are an expert insurance policy analyst. Analyze document sections and answer questions with precision.

ANALYSIS INSTRUCTIONS:
1. CAREFULLY read each document section
...
ANSWER:"""
        ...
        response = client.chat.completions.create(
            model="gpt-4o",  # You can change this to "gpt-3.5-turbo" for cost savings
            messages=[
